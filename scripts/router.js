...
router.setState = function(state) {
  ...
  let headerContent = document.querySelector('body header h1');
  if(state == null || state.name == 'homePage'){
    bodyContent.className = "home";
    headerContent.textContent = "Journal Entries";
  }
  if(state.name == 'entryPage'){
    ...
    bodyContent.insertBefore(entry, bodyContent.children[2]);
  }
  if(state.name == 'settingsPage'){
    bodyContent.className = "settings";
